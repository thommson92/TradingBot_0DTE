...
from tradingbot_0dte.ml.policy import select_trades  # noqa: E402
...
def main() -> int:
    ...
    oos_sel = select_trades(oos, args.pnl_hat_floor, max_trades_per_day=n)
    hold_sel = select_trades(holdout, args.pnl_hat_floor, max_trades_per_day=n)
