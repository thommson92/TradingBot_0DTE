...
from tradingbot_0dte.ml.dataset import (  # noqa: E402
    CandidateGrid, ExitRule, build_dataset, default_entry_times, save_dataset,
)
...
def main() -> int:
    ...
    print("Kandidatenraster: %d Entry-Zeiten x %d Deltas x %d Spread-Typen = %d Kandidaten/Tag"
          % (len(entry_times), len(grid.target_deltas), len(grid.spreads), n_candidates))
